...
export const PLAN_CATALOG: Record<PlanKey, PlanCatalogEntry> = {
  core: {
    ...
    bullets: [
      ...
      '2 campaign/output channels for LinkedIn-led content and exports',
  ...
  growth: {
    ...
    bullets: [
      ...
      '6 campaign/output channels for LinkedIn-led content and supporting exports',
  ...
  scale: {
    ...
    bullets: [
      ...
      'Up to 30 campaign/output channels across clients or offers',
      'Higher campaign and publishing/export volume',
