  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <h2 className="text-xl font-semibold">Billing, reports, reliability</h2>
            <p className="text-sm text-muted-foreground">
          ...
          <CardContent className="space-y-2 text-sm">
            ...
            <Link href="/app/reports" className="block font-medium text-primary">Open operational reports</Link>
