...
## Required for the commercial live test
...
## Recommended before broad production use

- `STRIPE_PRICE_SCALE` — optional if Scale is handled manually
- `S3_ENDPOINT` — required for R2/S3-compatible providers that are not standard AWS S3
- `S3_PUBLIC_BASE_URL` — required before promising customer-facing media URLs
- `INNGEST_EVENT_KEY`
- `INNGEST_SIGNING_KEY`
- `SENTRY_DSN`
